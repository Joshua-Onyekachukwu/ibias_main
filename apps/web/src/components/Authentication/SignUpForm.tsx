...
import { signup, signInWithSocial } from '@/app/auth/actions';
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-[25px] items-center">
                        ...
                        <div className="xl:ltr:pl-[90px] xl:rtl:pr-[90px] 2xl:ltr:pl-[120px] 2xl:rtl:pr-[120px] order-1 lg:order-2">
                            ...
                            <form action={formAction}>
                                ...
                                {state?.error && (
                                    <div className="mb-[15px] text-red-500 text-sm bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-md p-3">
                                        {state.error}
                                    </div>
                                )}

                                {state?.success && (
                                    <div className="mb-[15px] text-green-600 text-sm bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-md p-3">
                                        {state.success}
                                    </div>
                                )}
                                ...
                                <button
                                    type="submit"
                                    disabled={isPending}
                                    className="md:text-md block w-full text-center transition-all rounded-md font-medium my-[20px] md:my-[25px] py-[12px] px-[25px] text-white bg-primary-500 hover:bg-primary-400 disabled:opacity-70 disabled:cursor-not-allowed"
                                >
