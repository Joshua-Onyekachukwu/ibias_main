...
const RecentSales: React.FC = () => {
  ...
  return (
    <>
      <div className="ibias-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
        <div className="ibias-card-header mb-[20px] md:mb-[25px] flex items-center justify-between">
          ...
          <Menu as="div" className="ibias-card-dropdown relative">
            <MenuButton className="ibias-card-dropdown-btn inline-block rounded-md border border-[#F5F7F8] bg-[#F5F7F8] dark:bg-[#0a0e19] py-[5px] md:py-[6.5px] px-[12px] md:px-[19px] transition-all hover:bg-gray-50 dark:border-[#172036] dark:hover:bg-[#0a0e19]">
