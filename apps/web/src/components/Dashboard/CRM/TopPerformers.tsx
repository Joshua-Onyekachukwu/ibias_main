...
const TopPerformers: React.FC = () => {
  ...
  return (
    <>
      <div className="ibias-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div className="ibias-card-header mb-[20px] md:mb-[25px] flex items-center justify-between">
          <div className="ibias-card-title">
            <h5 className="!mb-0">Top Performers</h5>
          </div>

          <div className="ibias-card-subtitle">
            <Menu as="div" className="ibias-card-dropdown relative">
              <MenuButton className="ibias-card-dropdown-btn inline-block transition-all hover:text-primary-500">
        ...
        <div className="ibias-card-content">
