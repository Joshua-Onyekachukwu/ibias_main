  ...
  const series = [
    {
      name: "Sessions",
      data: [
        110, 120, 85, 130, 145, 120, 150, 155, 100, 130, 115, 170, 220, 165,
        140, 150, 100, 110, 90, 160, 125, 105,
      ],
    },
  ];
  ...
  return (
    <>
      <div className="ibias-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div className="ibias-card-content relative">
          <span className="block mb-[5px]">Sessions</span>

          <div className="flex items-center">
            <h6 className="!mb-0 !text-[20px]">3,800</h6>
