  ...
  return (
    <>
      <div className="ibias-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div className="ibias-card-header mb-[20px] md:mb-[25px] sm:flex justify-between">
          <div className="ibias-card-title">
            <h5 className="!mb-0">Analytics Overview</h5>
          </div>

          <div className="ibias-card-subtitle mt-[13px] sm:mt-0">
            <button
              type="button"
        ...
        <div className="ibias-card-content -mt-[9px] sm:-mt-[17px] md:-mt-[22px]">
