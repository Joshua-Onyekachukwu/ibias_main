...
const SalesByLocations: React.FC = () => {
  ...
  return (
    <>
      <div className="ibias-card border border-gray-100 dark:border-[#172036] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div className="ibias-card-header mb-[20px] md:mb-[25px] flex items-center justify-between">
          ...
          <div className="ibias-card-subtitle">
            <Menu as="div" className="ibias-card-dropdown relative">
              <MenuButton className="ibias-card-dropdown-btn inline-block transition-all text-[26px] text-gray-500 dark:text-gray-400 leading-none hover:text-primary-500">
