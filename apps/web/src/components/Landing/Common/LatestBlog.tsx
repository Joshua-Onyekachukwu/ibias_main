...
const LatestBlog: React.FC = () => {
  ...
  const blogPosts: BlogPost[] = [
    {
      id: 1,
      title: "Why Most Dashboards Fail SMBs",
      excerpt:
        "Data without action is noise. Here is how AI changes the game.",
    ...
    {
      id: 2,
      title: "5 Metrics You Should Check Daily",
      excerpt: "Forget vanity metrics. Focus on AOV, LTV, and CAC.",
    ...
    {
      id: 3,
      title: "The Future of E-commerce is Autonomous",
      excerpt: "Imagine a store that restocks itself. We are building it.",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[18px] md:gap-[22px] mb-[35px] md:mb-[45px] lg:mb-[55px] xl:mb-[65px] items-center">
          <div>
            ...
            <p className="!leading-[1.6]">
              Our philosophy on building profitable e-commerce businesses.
            </p>
          </div>
