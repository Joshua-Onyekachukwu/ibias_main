  ...
  const featurePoints: FeaturePoint[] = [
    {
      ...
      title: "Real-Time Growth Brief",
      description: "Get a daily summary of what happened and what to do next.",
    },
    {
      id: 2,
      icon: "/images/icons/check.svg",
      title: "Inventory Risks",
      description: "AI predicts stockouts before they happen.",
    },
    {
      id: 3,
      icon: "/images/icons/check.svg",
      title: "Profit Protection",
      description: "Alerts when ad spend eats into your margins.",
    },
    {
      id: 4,
      icon: "/images/icons/check.svg",
      title: "Customer Cohorts",
      description: "See which products bring back the best customers.",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-[25px] items-center">
            <div>
              ...
              <h2 className="!text-gray-900 dark:!text-white !font-medium md:-tracking-[1px] !text-xl md:!text-3xl lg:!text-4xl xl:!text-5xl xl:max-w-[540px] !leading-[1.2] !mb-[11px] md:!mb-[13px] lg:!mb-[15px]">
                Not just a dashboard. <br/> A strategy center.
              </h2>

              <p className="!leading-[1.6]">
                Traditional dashboards just show you the problem. IBIAS shows you the solution.
              </p>
            ...
            <div className="xl:max-w-[521px] ltr:xl:ml-auto rtl:xl:mr-auto text-center">
              <Image
                ...
                className="inline-block rtl:-scale-x-100 rounded-xl shadow-2xl"
                alt="ibias-dashboard-showcase-image"
                width={1042}
                height={1304}
              />
            </div>
