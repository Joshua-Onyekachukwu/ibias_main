...
const TopFeatures: React.FC = () => {
  ...
  const features: FeatureItem[] = [
    ...
    },
    {
      ...
      description: "Built-in protection with fraud monitoring and encryption.",
      offset: true,
    },
    {
      id: 6,
      icon: "/images/icons/bar-chart.svg",
      title: "24/7 Support",
      description: "We’re here to help, any time, with expert product support.",
    },
    {
      id: 7,
      icon: "/images/icons/edit.svg",
      title: "Workflow Automation",
      description: "Automate routine tasks and focus on scaling your business.",
      offset: true,
    },
    {
      id: 8,
      icon: "/images/icons/connect.svg",
      title: "Cloud Backup",
      description: "Your data is backed up and accessible from anywhere.",
    },
  ];
        ...
        <div className="container sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1308px] mx-auto px-[12px]">
          <div className="text-center mb-[35px] md:mb-[45px] lg:mb-[55px] xl:mb-[65px]">
            ...
            <p className="!leading-[1.6]">
              Ibias equips you with intelligent tools to run a high-performing
              online store.
            </p>
          </div>
