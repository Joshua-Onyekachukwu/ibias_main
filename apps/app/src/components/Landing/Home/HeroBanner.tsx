        ...
        <div className="container sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1308px] mx-auto px-[12px]">
          <div className="text-center">
            <div className="mx-auto lg:max-w-[850px] mb-[25px] md:mb-[50px] lg:mb-[80px] xl:mb-[105px]">
              ...
              <h2 className="!text-white !font-medium !text-[30px] md:!text-[45px] lg:!text-[55px] xl:!text-[72px] !leading-[1.2] -tracking-[1px] lg:-tracking-[1.5px] !mb-[12px] md:!mb-[15px]">
                All-in-One Platform for eCommerce Growth
              </h2>

              <p className="text-white md:text-[15px] lg:text-md !leading-[1.6]">
                The all-in-one solution to manage, grow, and scale your
                eCommerce business — faster.
              </p>
