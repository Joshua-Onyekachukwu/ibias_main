...
const TestimonialsContent: React.FC = () => {
  ...
  const testimonials: Testimonial[] = [
    ...
    },
    {
      ...
      rating: 5,
      content:
        "The onboarding was quick and easy. Within a day, we had insights we never thought possible. Trezo’s integrations with our existing tools were seamless and incredibly useful.",
      author: {
        name: "Sara M.",
    ...
    },
    {
      ...
      rating: 5,
      content:
        "Switching to Trezo was a game changer. From inventory tracking to customer analytics, it's all smooth and centralized. We've doubled our efficiency in just 3 months.",
      author: {
        name: "Jason L.",
    ...
    },
    {
      ...
      rating: 5,
      content:
        "Trezo feels like it was made for us. The automation features alone save us hours every week. We now focus more on customer service while the system takes care of the rest.",
      author: {
        name: "Priya D.",
